...
public class DbHandler {
    ...
    private static String connectionUrl = "jdbc:sqlserver://host.docker.internal:1433;database=pubs;user=SA;password=@Tomate11@’ -e MSSQL_PID=Express’;encrypt=true;trustServerCertificate=true";
